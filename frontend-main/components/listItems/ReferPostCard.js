...
const ReferPostCard = props => {
    const navigation = useNavigation();
    const { id, email, name, skills, expoToken, image, type, referID, selectedUsers, handleSelectedUsers ,handleUser} = props;
        ...
        <Box pb={3} pt={3} justifyContent='space-around' >
            ...
            <Center >
                <HStack justifyContent="space-between" width='90%'>
                    ...
                    <HStack   borderRadius={5} paddingTop={2} paddingBottom={2} paddingRight={150} width='300'>
                        <Image source={require('../Icons/Tick.png')} width={12} height={12} marginRight={10} borderRadius={40} marginLeft={3} marginTop={-0.5} alt="image" />
                        <VStack>
                            {handleUser(name)}
                 ...
                 <HStack paddingTop={2} paddingBottom={2}>
                     <Image source={{ uri: image }} width={12} height={12} marginRight={10} borderRadius={40} marginLeft={3} marginTop={-0.5} alt="image" />
                     <VStack >
                     <Text fontSize={14} fontWeight='bold'>{name}</Text>
                     <Text marginLeft={1} fontSize={11}>{skills}</Text>
                     </VStack>
